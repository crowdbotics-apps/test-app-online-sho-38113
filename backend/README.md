...
## Project Structure
    ...
    ├── test_app_online_sho_38113  # Django project configurations
...
1. Clone this repo and `cd test_app_online_sho_38113`
...
2. Clone this repo and `cd test_app_online_sho_38113`
